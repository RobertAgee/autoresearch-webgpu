...
There's noting else particularly crazy about this repo - it's a standard Svelte app. I was mostly just curious to try this out (+ send to others) and didn't want to do the install! 
